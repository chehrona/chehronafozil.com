    ...
    return (
        <div class="container">
            <div class="section">
                ...
                <div>Last updated: June 04, 2024</div>
            </div>
            <div class="section">
                <p>
                    This Privacy Policy describes My policies and procedures on
                    the collection, use, and disclosure of Your information when
                    You use the Service and informs You about Your privacy
            ...
            <div class="section">
                ...
                <div class="subsection">
                    ...
                    <p>
                        The words with initial capital letters have meanings
                ...
                <div class="subsection">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <strong>
                                <em>Recipe Manager</em>
                            </strong>
                            , the software program provided by the Developer.
                        </li>
                        <li>
                            <strong>Developer</strong> (referred to as either
                            "the Developer", "I", "Me", or "My" in this
                            Agreement) refers to the individual developer of
                            this app.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            the Developer. It refers to third-party companies or
                            individuals employed by the Developer to facilitate
                            the Service, to provide the Service on behalf of the
                            Developer, to perform services related to the
                            Service or to assist the Developer in analyzing how
                            the Service is used.
                        </li>
                        <li>
            ...
            <div class="section">
                ...
                <div class="subsection">
                    ...
                    <div class="subsection">
                        <h4>Personal Data</h4>
                        <p>
                            While using My Service, I may ask You to provide Me
                        ...
                        <ul>
                            <li>Username and password for Pinterest</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="section">
                ...
                <p>
                    The Developer may use Personal Data for the following
                    purposes:
                </p>
                <ul>
                    <li>
            ...
            <div class="section">
                ...
                <p>
                    I will retain Your Personal Data only for as long as is
                    necessary for the purposes set out in this Privacy Policy. I
                    will retain and use Your Personal Data to the extent
                    necessary to comply with My legal obligations (for example,
                    if I am required to retain your data to comply with
                    applicable laws), resolve disputes, and enforce My legal
            ...
            <div class="section">
                ...
                <p>
                    ...
                    the Developer's operating offices and in any other places
                ...
                <p>
                    I will take all steps reasonably necessary to ensure that
            ...
            <div class="section">
                ...
                <p>
                    You have the right to delete or request that I assist in
                    deleting the Personal Data that I have collected about You.
                </p>
                <p>
                    My Service may give You the ability to delete certain
                ...
                <p>
                    ...
                    manage Your personal information. You may also contact Me to
                    request access to, correct, or delete any personal
                    information that You have provided to Me.
                </p>
                <p>
                    Please note, however, that I may need to retain certain
                    information when I have a legal obligation or lawful basis
                    to do so.
                </p>
            </div>
            <div class="section">
                ...
                <div class="subsection">
                    ...
                    <p>
                        If the Developer is involved in a merger, acquisition,
                        or asset sale, Your Personal Data may be transferred. I
                ...
                <div class="subsection">
                    ...
                    <p>
                        Under certain circumstances, I may be required to
                ...
                <div class="subsection">
                    ...
                    <p>
                        I may disclose Your Personal Data in the good faith
            ...
            <div class="section">
                ...
                <p>
                    The security of Your Personal Data is important to Me, but
            ...
            <div class="section">
                ...
                <p>
                    My Service does not address anyone under the age of 13. I do
                    not knowingly collect personally identifiable information
                    from anyone under the age of 13. If You are a parent or
                    guardian and You are aware that Your child has provided Me
                    with Personal Data, please contact Me. If I become aware
                    that I have collected Personal Data from anyone under the
                    age of 13 without verification of parental consent, I take
                    steps to remove that information from My servers.
                </p>
                <p>
                    If I need to rely on consent as a legal basis for processing
                    Your information and Your country requires consent from a
                    parent, I may require Your parent's consent before I collect
            ...
            <div class="section">
                ...
                <p>
                    My Service may contain links to other websites that are not
                    operated by Me. If You click on a third party link, You will
                    be directed to that third party's site. I strongly advise
            ...
            <div class="section">
                ...
                <p>
                    I may update My Privacy Policy from time to time. I will
                    notify You of any changes by posting the new Privacy Policy
                    on this page.
                </p>
                <p>
                    I will let You know via email and/or a prominent notice on
                    My Service, prior to the change becoming effective and
            ...
            <div class="section">
                ...
                <ul>
                    <li>By email: chehronaifozil@gmail.com</li>
                </ul>
            </div>
        </div>
    );
